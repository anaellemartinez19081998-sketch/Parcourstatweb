...
def afficher_carte():
    ...
    query = db.session.query(
        ...
        func.avg(Admission.PA_F).label('moyenne_filles'),      # Directement le % filles
        func.avg(Admission.PA_NB_B).label('moyenne_boursiers'), # Directement le % boursiers
...
def get_geojson():
    ...
    try:
        ...
        return jsonify(data)
    except FileNotFoundError: #Si erreur, on retourne se message afin d'informer l'utilisateur.
